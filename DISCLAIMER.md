...
`payday-super-checker` (named *Charles Henry Wickens*) is an open-source deterministic calculation engine designed to assist payroll professionals and accountants in assessing statutory due dates under *Superannuation Guarantee (Administration) Act 1992 (SGAA 1992) s 6(1)*.
